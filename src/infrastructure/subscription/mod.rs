...
use crate::infrastructure::MarketScore;
...
///
/// ```
/// use edgelord::infrastructure::subscription::ConnectionEvent;
///
...
///
/// ```ignore
/// use edgelord::infrastructure::subscription::{SubscriptionManager, ConnectionEvent};
