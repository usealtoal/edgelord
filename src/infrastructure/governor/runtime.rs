...
///
/// ```
/// use edgelord::infrastructure::governor::runtime::LatencyTargets;
/// use std::time::Duration;
///
...
///
/// ```
/// use edgelord::infrastructure::governor::runtime::ScalingConfig;
/// use std::time::Duration;
///
...
///
/// ```
/// use edgelord::infrastructure::governor::runtime::LatencyMetrics;
/// use std::time::Duration;
///
