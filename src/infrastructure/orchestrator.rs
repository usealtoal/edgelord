...
use crate::application::cluster::ClusterDetectionService;
use crate::application::inference::{run_full_inference, InferenceService};
...
use crate::infrastructure::exchange::{ExchangeFactory, ReconnectingDataStream};
...
mod tests {
    ...
    fn event_processing_context_can_be_created() {
        ...
        let stats = crate::application::statistic::create_recorder(db_pool);
