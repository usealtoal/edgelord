...
Restructure documentation to be professional, clean, and comprehensive. Create a polished README with styled header and badges, and organize full documentation in doc/.

## Design Decisions

1. **Tone:** Professional OSS with subtle personality
2. **Plans:** Keep existing doc/plans/ as-is, just note they exist (don't link individually)
...
- Documentation (links to doc/ sections)
...
| Delete | doc/architecture/system-design.md (merged into overview.md) |
